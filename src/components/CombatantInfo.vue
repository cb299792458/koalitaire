<script setup lang="ts">
    ...
    const statTooltips = {
        ...
        pendingEndTurnDamage:
            'If you press End Turn now: your summons attack first, then net hearts lost from poison (if any)—poison is raw life loss (loseLife), not blocked and not absorbed by summons—then the enemy acts. Summon rows show extra ♥ loss they would take. Does not include recycling the tableau.',
