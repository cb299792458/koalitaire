...
export type CombatEvent =
    ...
    /** Before damage is applied to the enemy; listeners may mutate `payload`. Player outgoing knackered is applied after emit; enemy incoming decroded is applied in {@link Enemy.takeDamage}. */
...
export class CombatEventBus {
     ...
     * on `playerTurnEnded` run before summons and enemy actions unless they subscribe earlier.
     */
